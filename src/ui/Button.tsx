...
const variantStyles = {
  ...
  outline: `flex min-w-min appearance-none items-center justify-center gap-2 rounded-full border border-solid px-8 py-2 border-primary disabled:text-fg-disabled`,
